...
<script type="text/javascript">
  ...
  var iconApotek = L.icon({ iconUrl: "../file/alfa.jpeg", iconSize: [44, 44], iconAnchor: [22, 44], tooltipAnchor: [22, -20] });
  ...
  foreach ($data as $row) {
    ...
    echo "var marker = L.marker([" . $row->lat . ", " . $row->lng . "], {icon: iconApotek}).addTo(map).bindPopup('<b>" . $row->nama_apotik . "</b><br><img src=\"../file/" . $row->foto . "\" alt=\"Foto\" style=\"width: 100px; height: auto;\"><br>" . $row->alamat . "');";
  }
  ?>
